...
namespace Sandland.Domains.Core.Inspectors
{
    ...
    public class AnimatorExtensionEditor : UnityEditor.Editor
    {
        ...
        private void GenerateClass(Animator animator, string path)
        {
            ...
            var content = GetClassContent(animations, controller.name.ToPascalCase());
        ...
        private string GetClassContent(HashSet<string> animations, string controllerName)
        {
            ...
            stringBuilder.AppendLine($"public static class {controllerName}Animations");
            stringBuilder.AppendLine("{");

            foreach (var animation in animations)
            {
                stringBuilder.AppendLine($"\tpublic static readonly int {animation.ToPascalCase()} = Animator.StringToHash(\"{animation}\");");
            }
